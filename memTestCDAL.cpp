...
int main() {
	...
	CDAL<int> const Clist = list;

	CDAL<int>::const_iterator ClistIt = Clist.begin();
	CDAL<int>::const_iterator ClistEnd = Clist.end();

	for( ; ClistIt != ClistEnd; ++ClistIt )  { }


	// rule of five ===================//
	CDAL<int> listCopy = list;
	
	CDAL<int> listAssignment{};

	listAssignment = list;

	CDAL<int> listCM = std::move(list);
